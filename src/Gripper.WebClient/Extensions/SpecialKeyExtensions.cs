...
{
    internal static class SpecialKeyExtensions
    {
        internal static ICollection<DispatchKeyEventCommand> ToDispatchKeyEventCommands(this SpecialKey specialKey)
        {
            return specialKey switch
            {
                // '\b':     {"Backspace", "Backspace", "", "", 8, 8, false, false},
                SpecialKey.Backspace => new[] {
                    new DispatchKeyEventCommand { Type = "keyDown", Code = "Backspace", Key = "Backspace", Text = "\b", UnmodifiedText = "\b", NativeVirtualKeyCode = 8, WindowsVirtualKeyCode = 8 },
                    new DispatchKeyEventCommand { Type = "char", Code = "Backspace", Key = "Backspace", Text = "\b", UnmodifiedText = "\b", NativeVirtualKeyCode = 8, WindowsVirtualKeyCode = 8 },
                    new DispatchKeyEventCommand { Type = "keyUp", Code = "Backspace", Key = "Backspace", Text = "\b", UnmodifiedText = "\b", NativeVirtualKeyCode = 8, WindowsVirtualKeyCode = 8 }
                },

                // '\r':     {"Enter", "Enter", "\r", "\r", 13, 13, false, true},
                SpecialKey.Enter => new[] { new DispatchKeyEventCommand { Type = "char", Code = "Enter", Key = "Enter", Text = "\r", UnmodifiedText = "\r", NativeVirtualKeyCode = 13, WindowsVirtualKeyCode = 13 } },

                // '\t':     {"Tab", "Tab", "", "", 9, 9, false, false},
                SpecialKey.Tab => new[] { new DispatchKeyEventCommand { Type = "char", Code = "Tab", Key = "Tab", Text = "", UnmodifiedText = "", NativeVirtualKeyCode = 9, WindowsVirtualKeyCode = 9 } },
        ...
        // https://github.com/chromedp/chromedp/blob/fd310a9b849a/kb/keys.go
        // Code, Key, Text, Unmodified, Native, Windows, Shift, Print
